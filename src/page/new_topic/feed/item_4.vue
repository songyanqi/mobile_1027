<template >
  <div name="item4">
    <div class="img_container" v-if="environment=='menu'">
      <img src="http://pic.davdian.com/free/2017/01/16/750_580_66b9a8876371d17f0a9509bd9b50de3a.png" alt="">
    </div>

    <div v-if="environment=='preview'" class="goods_group_con">
      <div v-for="(item, index) in previewData" :key="index" class="cross_goods_item goods_cross">
        <div class="goods_img">
    ...
    <div v-if="environment=='show'" class="goods_group_con">
      <a :href="item.url" v-for="(item, index) in previewData" :key="index" class="cross_goods_item goods_cross">
        <div class="goods_img">
