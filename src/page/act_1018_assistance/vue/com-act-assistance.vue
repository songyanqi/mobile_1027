    ...
    <div>
      <ul>
        <li v-for="lis in response.goodsInfo" class="list_style online">
          ...
          <a class="remain_btns">
            <a class="panic_buying_btn" :class="{'yellows':lis.yellows == 2,'big_1018':lis.yellows == 3}" @click="activebtn(lis.activityLink)" href="javascript:void(0)">{{lis.activityButton}}</a>
