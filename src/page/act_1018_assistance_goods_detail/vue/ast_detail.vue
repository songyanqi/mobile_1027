  ...
  <div style="font-weight: normal;background-color: #FFFFFF;padding-bottom: 50px;" v-if="response">
    ...
    <div>
      ...
      <div class="detail_rule">
        ...
        6.10月18日当天以活动价支付购买活动商品，支付成功后该商品得到的助力金额将以返现的形式返到【我的】－【总额】－【待结算金额】－【其他收入】里，30天后如果没有退货将转到【待提现金额】，最高可0元抢购该商品；<br>
        7.其中爸爸的选择纸尿裤和羽绒服这两款商品助力所减金额，最晚于10月19日24点前返现到账，其他商品将在商品支付成功后实时返现；<br>
        8.已发起的助力商品可在【我的10.18】中查看；<br>
        9.详情可咨询大V店客服。
      </div>
      <!--按钮-->
