...
export default {
  ...
  debug(param = {}){
    new Vue({
      ...
      el: getEl(),
      data: {param},
      template: '<com-popup-base :class-name="param.className" type="debug" :title="param.title" :text="param.text" :ok-btn-title="param.btnTitle" :ok-btn-callback="param.btnCallback" :cancel-btn-title="param.cancelBtnTitle" :cancel-btn-callback="param.cancelBtnCallback"/>',
    });
  },
  /**
   * 功能：loading条
