...
<script>
    ...
    var vSchoolBanner = require("../module/vSchoolBanner.vue");
    var vSchoolList = require("../module/vSchoolList.vue");
...
//        },
        methods:{
            ...
            shareInfo:function () {
                let obj = {}
                obj.obj = {}
                axios.post('/api/mg/content/course/allCourseListShareInfo',lay.strSign(obj))
            ...
            scroll:function(){
                ...
                $(window).scroll(function(){//滚动条滚动事件
                    ...
                    if(offsetTop-offset-window.screen.availHeight<300){//如果滚动条到一定位置
                        scope.getData(false);
                    }
                })
            },
