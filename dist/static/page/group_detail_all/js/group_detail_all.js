...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  mounted: function mounted() {
	    ...
	    // 设置分享信息
	    _share2.default.setShareInfo(ts.response.data.shareInfo);
	    ...
	    getData: function getData() {
	      ...
	      _$2.default.ajax({
	        ...
	        data: _layout2.default.strSign('feed', {
	          ...
	          pageSize: 20,
	          groupId: _param2.default.get('group_id'), // || 1161193,
	          reverseId: _param2.default.get('reverse_id') // || 1161193,
	        }),
	        success: function success(response) {
	          debugger;
	          ts.ajaxing = false;
