...
/***/ function(module, exports, __webpack_require__) {
	...
	function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } // 基础模块
	...
	new _Vue2.default({
	  ...
	  watch: {
	    // 监听subjectResponse变化
	    subjectResponse: function subjectResponse() {
	  ...
	  methods: {
	    ...
	    getInit: function getInit() {
	      ...
	      _$2.default.ajax({
	        ...
	        type: 'post',
	        dataType: 'json',
	        data: (0, _encrypt2.default)({ js_wx_info: 1 }),
	        success: function success(response) {
	          if (response.code === 0) {
	            ts.initResponse = response;

	            // 强制跳转
	            _common2.default.checkRedirect(response);

	            // 设置分享信息
	            try {
	              _share3.default.setShareInfo({
	                title: ts.initResponse.data.nickName + '\u558A\u4F60\u4E00\u8D77\u505A\u5B9D\u5B9D\u8BC4\u6D4B\u9898',
	                desc: '测评通过智能、言语、情商、行为、艺术，5个方面发现您宝宝的优势特点',
	                link: location.href,
	                imgUrl: location.protocol + '//fe-ws.davdian.com/wap/static/dist/static/page/act_baby/img/share-icon.png'
	              }, response);
	            } catch (err) {
	              console.error(err);
	            }
	            ...
	            if (_ua2.default.isWeiXin()) {
	              ...
	              if (ts.initResponse.data.needWxAuth === '1' && _jsCookie2.default.get('act_baby_weixin_auth') === undefined) {
	                _jsCookie2.default.set('act_baby_weixin_auth', 1, {
	      ...
	      _$2.default.ajax({
	        ...
	        success: function success(response) {
	          if (response.code === 0) {
	            ...
	            try {
	              var totalPoint = 0;
	              for (var i in ts.resultResponse.data.point) {
	                totalPoint += ts.resultResponse.data.point[i] * 1;
	              }
	              _share3.default.setShareInfo(_defineProperty({
	            ...
	            ts.$nextTick(function () {
	              window.echarts.init(document.querySelector('.chart')).setOption({
	                ...
	                radar: [{
	                  indicator: [{ text: '智能 ', max: 100 }, { text: '言语', max: 100 }, { text: '情商', max: 100 }, { text: '行为', max: 100 }, { text: '  艺术', max: 100 }],
	                  center: ['50%', '45%'],
	                  radius: '70%',
	                  startAngle: 127,
	                  splitNumber: 4,
	                  ...
	                  splitArea: {
	                    areaStyle: {
	                      color: ['rgba(234, 128, 59, 1)', 'rgba(234, 128, 59, 0.52)', 'rgba(234, 128, 59, 0.25)', 'rgba(234, 128, 59, 0.15)']
	                    }
	                  },
	                  axisLine: {
	                    show: false
	                ...
	                series: [{
	                  ...
	                  type: 'radar',
	                  data: [{
	                    value: [ts.resultResponse.data.point.iq, ts.resultResponse.data.point.language, ts.resultResponse.data.point.eq, ts.resultResponse.data.point.action, ts.resultResponse.data.point.art],
	                    label: {
	                      normal: {
	                        show: true,
	                        textStyle: {
	                    ...
	                    // symbol: 'circle',
	                    symbol: 'image://' + location.protocol + '//fe-ws.davdian.com/wap/static/dist/static/page/act_baby/img/echarts-point.png',
	                    symbolSize: 10,
	                    lineStyle: {
	                      normal: {
	                        opacity: 0
	    ...
	    // 开始答题
	    begin: function begin(event) {
	      var ts = this;
	      if (ts.sex == null) {
	        _popup2.default.toast('性别是必选项，记得填哦～');
	        return;
	      } else if (ts.age == null) {
	        _popup2.default.toast('一定要告诉我们宝宝的年龄才能匹配符合的测试题哦');
	        return;
	      }
	      ts.getSubject();
	    },
	    ...
	    saveAnswer: function saveAnswer(answer) {
	      ...
	      setTimeout(function () {
	        ...
	        var tempNo = document.querySelector('#currentNo');
	        if (tempNo) {
	    ...
	    share: function share(event) {
	      if (_ua2.default.isWeiXin() || _ua2.default.isDvdApp()) {
	        _share3.default.callShare();
	      } else {
	        _popup2.default.alert('请在微信环境下分享');
	      }
	    }
	  },
	  filters: {}
