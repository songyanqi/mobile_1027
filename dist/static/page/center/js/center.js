...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tj2 = __webpack_require__(98);

	var _tj3 = _interopRequireDefault(_tj2);
	...
	new _Vue2.default({
	  ...
	  components: {
	    ...
	    'com-scroll-list': __webpack_require__(186),
	    'com-footer': __webpack_require__(191),
	    'g-top-tip': __webpack_require__(196)
	  },
	  props: {},
	  data: function data() {
	    return {
	      ...
	      guideStep: !_jsCookie2.default.get('centerGuideOver') && Date.now() < new Date("August 1,2017 00:00:00") * 1 ? 1 : 4,
	  ...
	  computed: {
	    ...
	    // 顶部提示类型
	    topTipType: function topTipType() {
	      return this.response.visitor_status === 1 && this.response.data.userInfo.attentionWeixin !== '1' ? 'focus' : this.response.visitor_status === 3 ? 'open' : '';
	    },
	  ...
	  methods: {
	      ...
	      _$2.default.ajax({
	        ...
	        error: function error(_error) {
	          ...
	          if (ts.getDataTryTimes < 3) {
	            ...
	            _popup2.default.toast(location.protocol + '//' + location.host + '/api/mg/user/center/index </br>ajax error: ' + _error.status + ' ' + _error.statusText);
	          }
	    ...
	    // 引导浮层下一步
	    guideStepNext: function guideStepNext() {
	      this.guideStep++;
	      if (this.guideStep > 3) {
	        _jsCookie2.default.set('centerGuideOver', '1', { expires: 365 * 2, domain: _util2.default.getBaseDomain() });
	      }
	    },

	    // 一元开店点击
	    oneKdClick: function oneKdClick() {
	      _popup2.default.confirm('<p>点击确定后将不能继续体验大V店</p><p>请慎重选择?</p>', function () {
	        _$2.default.ajax({
	          cache: false,
	          async: true,
	    ...
	    // 统计
	    tj: function tj(action_type, cmdContent) {
	      _tj3.default.send({
	        production: 17,
	        action: 1,
	    ...
	    getMarginOrBorderTop: function getMarginOrBorderTop(value, type) {
	      if (type == 'border') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//       <!--<img src="//fe-ws.davdian.com/wap/static/dist/static/page/center/img/footer-cart.png">-->
	//       <!--</div>-->
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/page/center/vue/g-top-tip.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-10502da6/g-top-tip.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js!../../../../node_modules/sass-loader/index.js!../../../../node_modules/vux-loader/src/style-loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./g-top-tip.vue", function() {
				var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js!../../../../node_modules/sass-loader/index.js!../../../../node_modules/vux-loader/src/style-loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./g-top-tip.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".g-top-tip {\n  position: fixed;\n  top: 0;\n  width: 100%;\n  background: #F1F1F1;\n  max-width: 640px; }\n  .g-top-tip .tip-wrapper {\n    display: -webkit-box;\n    display: -webkit-flex;\n    display: -moz-box;\n    display: -ms-flexbox;\n    display: flex;\n    height: 44px;\n    line-height: 44px; }\n    .g-top-tip .tip-wrapper > * {\n      vertical-align: middle; }\n    .g-top-tip .tip-wrapper .close {\n      width: 40px; }\n    .g-top-tip .tip-wrapper .words {\n      -webkit-box-flex: 1;\n      -webkit-flex: 1;\n         -moz-box-flex: 1;\n          -ms-flex: 1;\n              flex: 1;\n      display: block;\n      margin-left: 10px;\n      font-size: 12px; }\n    .g-top-tip .tip-wrapper .btn {\n      padding-right: 10px; }\n      .g-top-tip .tip-wrapper .btn a {\n        margin-top: -3px;\n        padding: 0 10px;\n        display: inline-block;\n        font-size: 11px;\n        height: 24px;\n        line-height: 24px;\n        color: white;\n        background-image: -webkit-gradient(linear, right top, left top, from(#FF5B5B), to(#FA1862));\n        background-image: -webkit-linear-gradient(right, #FF5B5B 0%, #FA1862 100%);\n        background-image: linear-gradient(-90deg, #FF5B5B 0%, #FA1862 100%);\n        border-radius: 100px;\n        vertical-align: middle; }\n  .g-top-tip .g-focus-qrcode {\n    position: fixed;\n    top: 0;\n    width: 100%;\n    max-width: 640px;\n    height: 100%;\n    background: rgba(0, 0, 0, 0.6); }\n    .g-top-tip .g-focus-qrcode .panel {\n      position: absolute;\n      left: 0;\n      right: 0;\n      top: 0;\n      bottom: 0;\n      margin: auto;\n      width: 2.75rem;\n      height: 2.75rem;\n      background: #fff; }\n      .g-top-tip .g-focus-qrcode .panel .close {\n        position: absolute;\n        top: 0.1rem;\n        right: 0.1rem;\n        display: inline-block;\n        width: 0.16rem;\n        height: 0.16rem;\n        line-height: 0.16rem; }\n      .g-top-tip .g-focus-qrcode .panel .qrcode {\n        margin: 0.25rem auto 0.1rem;\n        display: inline-block;\n        width: 1.8rem;\n        height: 1.8rem;\n        line-height: 1.8rem;\n        display: block; }\n      .g-top-tip .g-focus-qrcode .panel .words {\n        margin: 0;\n        font-size: 0.14rem;\n        line-height: 0.2rem;\n        text-align: center; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  computed: {
	    // 立即打开
	    isTipOpen: function isTipOpen() {
	      var maxAge = localStorage.getItem('isTipOpen_maxAge');
	      return this.type == 'open' && (!maxAge || Date.now() > maxAge) ? true : false;
	    },

	    // 立即关注
	    isTipFocus: function isTipFocus() {
	      var maxAge = localStorage.getItem('isTipFocus_maxAge');
	  ...
	  methods: {
	    openApp: function openApp() {
	      _native2.default.custom.invoke();
	    },
	    focus: function focus() {
	      var guideTarget1 = document.querySelector('.g-guide-target-1');
	      if (guideTarget1) {
	...
	//       <img class="close" src="//fe-ws.davdian.com/wap/static/dist/static/page/center/img/close.png" @click="type = ''">
	...
	//       <div class="panel">
	//         <img class="close" src="//fe-ws.davdian.com/wap/static/dist/static/page/center/img/focus-close.png" @click="showQrCode = 0;">
	//         <img class="qrcode" src="//fe-ws.davdian.com/wap/static/dist/static/page/center/img/focusQrCode.jpeg">
	//         <div class="words">
	//           <p>长按二维码</p>
	//           <p>关注大V店公众号</p>
	//         </div>
