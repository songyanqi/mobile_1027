...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tjAncestor = __webpack_require__(1120);
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      ...
	      subjectNo: 1,
	      // 关卡描述
	      passDesc: __webpack_require__(1121),
	      // 判断用户是否已经回答过当前题目
	      userIsAnswer: false,
	      // 记录用户答题id
	      userSubjectArray: [],
