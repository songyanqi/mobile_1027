	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      ...
	      subjectNo: 1,
	      // 关卡描述
	      passDesc: __webpack_require__(814),
	      // 判断用户是否已经回答过当前题目
	      userIsAnswer: false,
	      // 记录用户答题id
	      userSubjectArray: [],
