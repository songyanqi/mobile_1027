...
/***/ function(module, exports, __webpack_require__) {
	...
	var kindsearch = __webpack_require__(1311);
	var cate = __webpack_require__(1314);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-6902635d/new_search.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-72948b26/categorymain.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        //
	        var scope = this;
	        this.initData(this, function () {
	            return _this.initMenu();
	        });
	        this.initBanner();
	    },
	    methods: {
	        ...
	        refreshRight: function refreshRight() {
	        ...
	        initMenu: function initMenu(index) {
	        ...
	        initRight: function initRight(pos) {
	            var config = { mouseWheel: true, preventDefault: false, bounce: true };
	            if (pos) {
	                config.startY = pos;
	            }
	        ...
	        initData: function initData(category) {
	            var _this2 = this;
	            ...
	            if (data) {
	                ...
	                this.list = data.list;
	                this.$nextTick(function () {
	                    return _this2.initMenu(data.index);
	                });
	                this.category = data.category;
	                this.$nextTick(function () {
	                    return _this2.initRight(data.pos);
	                });
	            } else {
	                // 否则从网络请求
	                $.ajax({
	        ...
	        setCacheData: function setCacheData(data) {
	            localStorage.category = JSON.stringify(data);
	        },
	        leftScroll: function leftScroll(imm) {
