...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    ...
	    */
	    ...
	    var orderList = __webpack_require__(1361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0bec4ec6/orderList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	// <script>
	var orderlistswitcher = __webpack_require__(1363);
	exports.default = {
	    components: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-59926b07/orderlistswitcher.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	// <script>
	var orderlistitem = __webpack_require__(1365);
	exports.default = {
	    data: function data() {
	        return {
	            selected: '',
	    ...
	    created: function created() {
	        ...
	        if (patharr.length > 2) {
	            ...
	            if (lastPath == 'order_detail' || lastPath == 'order_delivery' || lastPath == "detail" || lastPath == "grade" || lastPath == "add_address" || lastPath == "agent_pay" || lastPath == "cart_confirm" && $.cookie && !$.cookie("dvd_cart_to_confirm")) {
	                //判断是否是浏览器上的返回键回到这个页面
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-22fa258e/orderlistitem.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        // 确认收货
	        orderArrive: function orderArrive() {
	            var vm = event.currentTarget,
	    ...
	    filters: {
	        ...
	        checkship: function checkship(value) {
	            if (value.is_new_seller_order == false) {
	                if (value.type == 1) {
	                    if (value.shipping_status == 1) {
	                        return true;
	        ...
	        cancel1: function cancel1(value) {
	            if (value.is_new_seller_order == false) {
	                if (value.type == 2) {
	        ...
	        cancel2: function cancel2(value) {
	            if (value.is_new_seller_order == false) {
	                if (value.type == 2) {
	                    if (value.cancel_type) {
	        ...
	        cancel3: function cancel3(value) {
	            if (value.is_new_seller_order == false) {
	                if (value.type == 2) {
	                    if (value.cancel_type) {
	        ...
	        shipping: function shipping(value) {
	    ...
	    events: {
	        'changeSort': function changeSort(msg) {
	            var vm = this;
	            vm.selected = msg;
	            vm.list_type = [];
