...
/***/ function(module, exports, __webpack_require__) {
	...
	new _Vue2.default({
	    el: "#guide",
	    components: {
	        guide: __webpack_require__(1199)
	    }
	}); /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js!../../../../node_modules/vux-loader/src/style-loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./guide.vue", function() {
				var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js!../../../../node_modules/vux-loader/src/style-loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./guide.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	//     <div class='container'>
	//         <div class='guide1'>
	//             <img src="//pic.davdian.com/free/2017/06/07/guideBg.png" v-if='!giftButton' class='guide1Bg'>
	//             <img src="//pic.davdian.com/free/2017/06/22/success_bg1.png" v-if='giftButton' class='guide1Bg'>
	//             <div class='exit' @click='goProfile'></div>
	//             <div class='guide1Title guide1all'>您已成功开通大V店会员</div>
	//             <div class='guide1Content guide1all' v-if='bonusFlag'>{{bonus.bonusCountMoney}}元红包<span>已到账</span></div>
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        init: function init() {
	            var that = this;
	            axios.post('/api/mg/user/memberbuy/success', (0, _utils.strSign)({ orderId: window.location.pathname.split('.')[0].split('-')[2] })).then(function (respone) {
