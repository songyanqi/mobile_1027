...
/***/ function(module, exports, __webpack_require__) {
	...
	var _goods = __webpack_require__(1176);
	...
	exports.default = {
	  ...
	  mounted: function mounted() {
	    ...
	    if (!this.response.data.goodsInfo) {
	      _popup2.default.alert('<p>该商品组团已结束啦～</p>看看其他组团商品吧～', function () {
	        location.href = '/group_list.html';
	      });
	    }
	  ...
	  methods: {
	    ...
	    getData: function getData() {
	      ...
	      _$2.default.ajax({
	        ...
	        type: 'post',
	        dataType: 'json',
	        data: _layout2.default.strSign('group_goods', {
	          reverseId: _param2.default.get('reverse_id') || '', // || '3584',
	          groupId: _param2.default.get('group_id') || '',
	          sourceRefer: _param2.default.get('sourceRefer') || ''
	        }),
	        success: function success(response) {
	    ...
	    joinOtherGroupClick: function joinOtherGroupClick() {
	...
	module.exports = {
		...
		"data": {
			"goodsInfo": {
				"goodsName": "组团商品名称",
				"goodsImgUrl": "组团商品图片",
				"goodsStock": "可用库存 0/1/2/...",
				"goodsStatus": "商品状态 售罄、下架...",
				"discount": "优惠信息",
				"pepoleNumber": "组团人数",
				"goodsPrice": "组团价格",
				"realShopPrice": "真实价格(大V店原价)",
