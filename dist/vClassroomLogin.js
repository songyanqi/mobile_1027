...
/***/ function(module, exports, __webpack_require__) {
	...
	var vClassroomLogin = __webpack_require__(1705);
	// var title = require("../module/title.vue");

	new Vue({
	    el: "#vClassroomLoginContainer",
	    data: {},
	    components:{
	        vClassroomLogin:vClassroomLogin
	    },
	    created:function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_template__ = __webpack_require__(1710)
	module.exports = __vue_script__ || {}
	if (module.exports.__esModule) module.exports = module.exports.default
	var __vue_options__ = typeof module.exports === "function" ? (module.exports.options || (module.exports.options = {})) : module.exports
	if (__vue_template__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5f27c25b/vClassroomLogin.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vClassroomLogin = __webpack_require__(1709);
	...
	// </template>
	// <script>
	exports.default = _vClassroomLogin2.default;
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        testPhoneNumber: function testPhoneNumber() {
	            var that = this;
