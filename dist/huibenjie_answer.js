...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoRootSize = __webpack_require__(1109);
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      ...
	      subjectNo: 1,
	      // 关卡描述
	      passDesc: __webpack_require__(1214),
	      // 判断用户是否已经回答过当前题目
	      userIsAnswer: false,
	      // 记录用户答题id
	      userSubjectArray: [],
