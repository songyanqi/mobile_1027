...
/***/ function(module, exports, __webpack_require__) {
	...
	var search = __webpack_require__(1442);
	var category_sort = __webpack_require__(1445);
...
/***/ function(module, exports) {
	...
	exports.default = {
	    data: function data() {
	        ...
	        }, _defineProperty(_ref, "goodsList", $(".good_list_2_row")), _defineProperty(_ref, "filterContainer", $(".filter_container")), _defineProperty(_ref, "list", []), _defineProperty(_ref, "dvd_index_search", $.cookie("dvd_index_search")), _defineProperty(_ref, "cateStaticStr", 'dvd_search_category'), _defineProperty(_ref, "c_bind", null), _ref;
	    },
	    ...
	    methods: {
	        // 输入时候向后台查询
	        searchLike: function searchLike() {
	            var scope = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-59001024/category_sort.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// </template>
	// <script>
	var category = __webpack_require__(548);
	exports.default = {
	    data: function data() {
	        return {
	            data: {},
	    ...
	    methods: {
	        ...
	        filter: function filter() {
	            ...
	            scope.typePage = [1, 1, 1, 1, 1], scope.data.page = 1;
	            scope.data.type = type;
	            scope.data.min = scope.minPrice || null;
	        ...
	        //滚动事件
	        scrollListener: function scrollListener(flag) {
	            var scope = this;
	            if (flag) {
	        ...
	        //获取数据函数
	        getGoodsData: function getGoodsData(data, callback) {
	            var scope = this;
	            scope.loading = true;
	            if (scope.ajaxing) {
	                scope.ajaxing = false;
