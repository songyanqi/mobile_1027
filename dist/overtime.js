...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(1371);
	new Vue(config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5b51616c/overtime.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vux-loader/src/style-loader.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./overtime.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js!../../node_modules/vux-loader/src/style-loader.js!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./overtime.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	      ...
	      if (!scope.no_more) {
	        if (scope.ajaxing) {
	          ...
	          $.ajax({
	            ...
	            data: _api2.default.strSign('like'),
	            dataType: 'json',
	            success: function success(data) {
	              if (data.data) {
	                localStorage.setItem('likeList', JSON.stringify(data));
	                sessionStorage.setItem('likeList', JSON.stringify(data));
	                scope.list = data.data.feedList[0].body.dataList, scope.beforeFirstLoading = false, scope.no_more = true;
	              } else {
	                scope.list = JSON.parse(localStorage.getItem('likeList')).data.feedList[0].body.dataList, scope.beforeFirstLoading = false, scope.no_more = true;
	              }
	              scope.ajaxing = true, scope.errors = false;
	            },
	            error: function error(e) {
	              scope.errors = true;
	              scope.ajaxing = false;
