...
/***/ function(module, exports, __webpack_require__) {
	...
	var idcardList = __webpack_require__(1243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js!../node_modules/vux-loader/src/style-loader.js!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./idcardList.vue", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/vue-loader/lib/style-rewriter.js!../node_modules/vux-loader/src/style-loader.js!../node_modules/vue-loader/lib/selector.js?type=style&index=0!./idcardList.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	    ...
	    methods: {
	        appdata: function appdata() {
	            ...
	            var mincallback = function mincallback() {
	                that.getData();
	            };
	        ...
	        deleteCard: function deleteCard(index, idcard_id) {
	            var that = this;
	        ...
	        checkout: function checkout(index, idcard_id) {
	            var that = this;
