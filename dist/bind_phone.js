...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Created by Murphy.lee on 17/4/24.
	 */
	var input_container = __webpack_require__(450);
	new Vue({
	  el: "#container",
	  data: function () {
	    return {
	  ...
	  methods: {
	    checkNumber: function checkNumber() {
	      ...
	      if (!/^1[3|4|5|7|8][0-9]{9}$/.test(scope.phoneNum)) {
	        ...
	        $.ajax({
	          ...
	          data: _layout2.default.strSign("bind_phone", { mobile: scope.phoneNum }),
	          dataType: "json",
	          success: function success(result) {
	            if (result.code) {
	    ...
	    sub: function sub() {
	      ...
	      $.ajax({
	        ...
	        data: _layout2.default.strSign("bind_phone", { mobile: scope.phoneNum, captcha: scope.checkNum }),
	        dataType: "json",
